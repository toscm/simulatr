...
param:
   pic: system.file("Pictures/const_batch_effect1.jpg", package="simulatr")
vignette: >
...
devtools::load_all()
x <- system.file("Pictures/const_batch_effect1.jpg", package="simulatr")
cat(x, file = "C:/Users/ASUS/simulatr/tmp.txt")
```
